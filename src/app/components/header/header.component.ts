...
@Component({
  ...
  template: `
    <header
      class="flex items-center justify-between py-4 border-b border-slate-700/50 mb-6"
    >
      ...
      <div class="flex items-center space-x-6">
        <div
          class="hidden md:flex items-center space-x-1 bg-slate-800/50 rounded-full px-3 py-1.5 border border-slate-700/50 backdrop-blur-sm"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
        ...
        <div class="flex items-center space-x-3">
          <button
            class="relative text-slate-400 hover:text-slate-100 bg-transparent border-none p-2 rounded-md"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
            ...
            <span
              class="absolute -top-1 -right-1 h-2 w-2 bg-cyan-500 rounded-full animate-pulse"
            ></span>
          </button>
