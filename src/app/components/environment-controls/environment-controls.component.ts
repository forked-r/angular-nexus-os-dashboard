  ...
  template: `
    <div class="bg-slate-900/50 border-slate-700/50 backdrop-blur-sm rounded-lg border">
      <div class="pb-2 px-6 pt-6">
        <div class="text-slate-100 text-base font-medium">Environment Controls</div>
      </div>
      <div class="px-6 pb-6">
        <div class="space-y-4">
          <div *ngFor="let control of controls; let i = index" class="flex items-center justify-between">
            <div class="flex items-center">
              <span [innerHTML]="control.icon" class="text-cyan-500 mr-2"></span>
